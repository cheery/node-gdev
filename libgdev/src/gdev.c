...
void gdevInit() {
    ...
    e = eglInitialize(display, NULL, NULL);
...
int toGDevError(EGLint e)
{
    switch(e) {
        ...
        case EGL_NOT_INITIALIZED:
            return GDEV_SYSTEM_ERROR;
        case EGL_BAD_ACCESS:          return GDEV_BAD_ACCESS;
        case EGL_BAD_ALLOC:           return GDEV_BAD_ALLOC;
        case EGL_BAD_ATTRIBUTE:       return GDEV_BAD_ATTRIBUTE;
        case EGL_BAD_CONFIG:          return GDEV_BAD_CONFIG;
        case EGL_BAD_CONTEXT:         return GDEV_BAD_CONTEXT;
        case EGL_BAD_CURRENT_SURFACE: return GDEV_BAD_CURRENT_SURFACE;
        case EGL_BAD_MATCH:           return GDEV_BAD_MATCH;
        case EGL_BAD_NATIVE_PIXMAP:   return GDEV_BAD_NATIVE_PIXMAP;
        case EGL_BAD_PARAMETER:       return GDEV_BAD_PARAMETER;
        case EGL_BAD_SURFACE:         return GDEV_BAD_SURFACE;
        case EGL_CONTEXT_LOST:        return GDEV_CONTEXT_LOST;
    }
    return GDEV_UNKNOWN_ERROR;
}
